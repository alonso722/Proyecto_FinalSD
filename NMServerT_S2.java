        ...
        try {
            ...
            while ((lineIn = entrada.readLine()) != null) {// mientras enviemos algun mensaje
                ...
                if (lineIn.equals("\"FECHA\"")) {// si nos piden la fecha
                    ...
                    escritor.println(
                            "Usiel Alonso Olivares-Lopez Lopez Arturo-Gerardo Islas Santana-Maria Flores Juarez-Rembrant Jesus Perez-Thomas Rodriguez Venegas-Juan Perez Cruz-Luis Diaz Ordaz-Luis Nava -Yarib Espinoza-Maria Angeles Cruz-Paola Nava Piña-Cesar Cruz Torres-Julio Vargas-Jesus Trujillo-Pedro Hernan-Juan de la Cruz-Cristo Espinoza-Miguel Cruz-Javet Espinoza");
                    escritor.flush();
