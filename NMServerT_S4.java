...
//NewMultiServerThread de la sucursal4

public class NMServerT_S4 extends Thread {// UA server que se conecta al puerto 13777
    ...
    public NMServerT_S4(Socket socket) {// constructor de nuestro NewMultiServerThread
        super("NMServerT_S4");
        this.socket = socket;
    ...
    public void run() {
        ...
        try {
            ...
            while ((lineIn = entrada.readLine()) != null) {// mientras enviemos algun mensaje
                ...
                if (lineIn.equals("\"FECHA\"")) {// si nos piden la fecha
                ...
                } else if (lineIn.equals("SUCURSAL004")) {// si pedimos que nos encripten los datos
                    escritor.println("Bienvendoa la sucursal 4");
                    escritor.flush();

                } else if (lineIn.equals("SUCURSAL004-CUENTA")) {// si pedimos que nos encripten los datos
                    escritor.println(
                ...
                } else if (lineIn.equals("SUCURSAL004-CURP")) {// si pedimos que nos encripten los datos
                    escritor.println(
                ...
                } else if (lineIn.equals("SUCURSAL004-NOMBRE")) {// si pedimos que nos encripten los datos
                    escritor.println(
                            "ANDREA-DAVID-ROLLAS-GERRY-MIKE-JONE-ALBERTO-IVETTE-JOSE-LIDIA-ANGEL-MANUEL-SILVIA-IVETTE");
                    escritor.flush();

                } else if (lineIn.equals("SUCURSAL004-APELLIDO")) {// si pedimos que nos encripten los datos
                    escritor.println(
                            "H-H-H-H-H-H-H-H-H-H-H-H-H-H");
                    escritor.flush();

                } else if (lineIn.equals("SUCURSAL004-SALDO")) {// si pedimos que nos encripten los datos
                    escritor.println(
                            "100-101-102-103-104-105-106-107-108-109-110-111-112-113");
                    escritor.flush();

                } else if (lineIn.equals("SUCURSAL004-DATOS")) {// si pedimos que nos encripten los datos
                    escritor.println(
                            "XTA00001-XTA00002-XTA00003-XTA00004-XTA00005-XTA00006-XTA00007-XTA00008-XTA00009-XTA00010-XTA00011-XTA00012-XTA00013-XTA00014"
                                    + "CURP010101-CURP010102-CURP010103-CURP010104-CURP010105-CURP010106-CURP010107-CURP010108-CURP010109-CURP010110-CURP010111-CURP010112-CURP010113-CURP010114"
                                    + "ANDREA-DAVID-ROLLAS-GERRY-MIKE-JONE-ALBERTO-IVETTE-JOSE-LIDIA-ANGEL-MANUEL-SILVIA-IVETTE"
                    ...
                    System.out.println("Server12344: " + lineX);
                    DatosEnviadosX = "FIN";
                    escritorX.println(DatosEnviadosX);
                    ...
                    escritorX.close();
                    entradaX.close();
                    escritor.println("Response from Server 12344... " + lineX);
                    escritor.flush();
                } else {
