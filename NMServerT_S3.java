...
//NewMultiServerThread de la sucursal3

public class NMServerT_S3 extends Thread {// UA server que se conecta al puerto 12343
    ...
    public NMServerT_S3(Socket socket) {// constructor de nuestro NewMultiServerThread
        super("NMServerT_S3");
        this.socket = socket;
        ...
        try {
            ...
            while ((lineIn = entrada.readLine()) != null) {// mientras enviemos algun mensaje
                ...
                if (lineIn.equals("\"FECHA\"")) {// si nos piden la fecha
                    ...
                    escritor.println("Bienvendoa la sucursal 1 parte C");
                    escritor.flush();
                    ...
                    escritor.println(
                            "NIO-JOSELUIS-GERARDO-ALBERTO-IVETTE-JOSE--ALBERTO-IVETTE-MIKE-JON-ALBERTO-IVETTE-JOSE-LIDIA");
                    escritor.flush();
                    ...
                    escritor.println(
                            "OOAZ900824MTSRLL08- SAPM880429MTSNRR00-GORM680121MTSNDG06-ROBG900321MTSDRD01-OIRY910429MTSRDL02-EIRJ720502HTSSDN06-RIVS770301HTSVZL05-SORE610611MTSLMM04-TITD600101HTSNRN09-MOCG481211MTSRSD25-MERG690406HTSDDD03- CALF631005HTSSDR02-GAMS661004HTSLDL05-SECM620929HTSGPG06-AALT601015HTSLPR00-GORE781222HTSNBF01- MAMG940610HTSRRL03- TORA780313MTSRDD04-TIPC490202HTSNZN07-GACR450423HSPMMD06");
                    escritor.flush();
                    ...
                    System.out.println("Server12343: " + lineX);
                    DatosEnviadosX = "FIN";
                    escritorX.println(DatosEnviadosX);
                    ...
                    escritorX.close();
                    entradaX.close();
                    escritor.println("Response from Server 12343... " + lineX);
                    escritor.flush();
                } else {
