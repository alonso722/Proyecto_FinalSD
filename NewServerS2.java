...
public class NewServerS2 {
    ...
    public static void main(String[] argumentos) throws IOException {
        ...
        try {// nos tratamos de conectar al puerto 12342
            socketServidor = new ServerSocket(12342);
        ...
        System.out.println("Server 12342 started... (Socket TCP)");
        int enproceso = 1;
        ...
        System.out.println("Finalizando Servidor 12342...");
